...
export default async function AdminPage() {
  ...
  const document = await readDocument().catch(() => null);
  if (!document) {
  ...
  return <AdminEditor initial={document} uploadsEnabled={!process.env.VERCEL} canSave={!process.env.VERCEL || usesRedis()} />;
}
