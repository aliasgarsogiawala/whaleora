  ...
  return (
    <main>
        ...
        <div className="hero-inner shell">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              ...
              <Link href="/products/sos-alarm" className="text-link">Start with the SOS Alarm <span aria-hidden="true"><ArrowUpRight size={16} strokeWidth={2} /></span></Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="collection-section section-pad" data-reveal>
        ...
        <div className="center-action"><Link href="/products" className="button button-outline">See all four, with specs <span aria-hidden="true"><ArrowRight size={16} strokeWidth={2} /></span></Link></div>
      </section>
      ...
      <section className="hub-preview section-pad" data-reveal>
        <div className="shell hub-intro">
          ...
          <div>
            ...
            <Link href="/safety-hub" className="button button-light">Read the guides <span aria-hidden="true"><ArrowUpRight size={16} strokeWidth={2} /></span></Link>
          </div>
        </div>
        <div className="shell editorial-grid">
          <Link href="/safety-hub" className="feature-story">
            ...
            <strong>Read the ten habits <ArrowRight size={15} strokeWidth={2} aria-hidden="true" /></strong>
          </Link>
          <div className="secondary-stories">
            <Link href="/safety-hub"><small>Checklist · Travel</small><h3>Before the cab arrives</h3><span>3 min <ArrowUpRight size={14} strokeWidth={2} aria-hidden="true" /></span></Link>
            <Link href="/safety-hub#emergency-card"><small>Tool · Emergency prep</small><h3>Build a contact card</h3><span>5 min <ArrowUpRight size={14} strokeWidth={2} aria-hidden="true" /></span></Link>
          </div>
        </div>
      </section>
      ...
      <section className="partnership-strip" data-reveal>
        <div className="shell">
          ...
          <Link href="/institutions" className="button button-light">See how partnerships work <span aria-hidden="true"><ArrowRight size={16} strokeWidth={2} /></span></Link>
        </div>
      </section>
      ...
      <section className="founder-story" data-reveal>
        ...
        <div className="founder-copy">
          ...
          <Link href="/about" className="arrow-link">Read the full story <span aria-hidden="true"><ArrowUpRight size={16} strokeWidth={2} /></span></Link>
        </div>
      </section>
    </main>
  );
